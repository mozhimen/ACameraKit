...
import com.mozhimen.camerak.dahua.exam.module.PlayBackModule;
...
public class PlaybackActivity extends AppCompatActivity
            ...
            switch (msg.what) {
                case UPDATE_PLAYBACK_PROGRESS:
                    ...
                    if (currentProgress != offset) {
                        Log.d(TAG, "CurrentProgress: " + currentProgress + " time is " + new Date(System.currentTimeMillis()).toString());
    ...
    public void onClick(View v) {
        int id = v.getId();
        if (id == R.id.play_start_pause) {
            play();
        } else if (id == R.id.play_fast) {
            playFast();
        } else if (id == R.id.play_slow) {
            playSlow();
        } else if (id == R.id.play_normal) {
            playNormal();
        } else if (id == R.id.playback_date) {
            selectPlayBackTime();
        } else if (id == R.id.start_playback) {
            playBack();
        } else if (id == R.id.local_capture_picture) {
            localCapturePicture();
        } else if (id == R.id.mark_record) {
            if (isPlaying) {
                stopPlayBack();
            }
            markRecord();
        } else if (id == R.id.download_record) {
            if (isPlaying) {
                stopPlayBack();
            }
            downloadRecord();
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        ...
        if (parentID == R.id.select_channel || parentID == R.id.select_stream_type || parentID == R.id.select_recordfile_type) {
            playBackChanged();
        }
    }
...
//                ToolKits.writeLog("time = " + time.toString());
    ...
    private class PlayBackProgress implements SeekBar.OnSeekBarChangeListener {
        ...
        public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
            ...
            ToolKits.writeLog("CurrentProgress: OSDTime = " + temp);
