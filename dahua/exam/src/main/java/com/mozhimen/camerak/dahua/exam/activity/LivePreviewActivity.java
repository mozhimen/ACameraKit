...
import static com.mozhimen.camerak.dahua.exam.module.OSDModule.GetChannelInfoListener;
import static com.mozhimen.camerak.dahua.exam.module.OSDModule.GetTimeTitleInfoListener;
import static com.mozhimen.camerak.dahua.exam.module.OSDModule.SetChannelInfoListener;
import static com.mozhimen.camerak.dahua.exam.module.OSDModule.SetTimeTitleInfoListener;
...
import com.mozhimen.camerak.dahua.exam.common.LivePreviewModule;
import com.mozhimen.camerak.dahua.exam.common.ToolKits;
import com.mozhimen.camerak.dahua.exam.module.CapturePictureModule;
import com.mozhimen.camerak.dahua.exam.module.EncodeModule;
import com.mozhimen.camerak.dahua.exam.module.OSDModule;
...
public class LivePreviewActivity extends AppCompatActivity implements
    ...
    public void onClick(View v) {
        ...
        int viewId = v.getId();
        if (viewId == R.id.preview_ptz_control) {
            // 云台控制
        ...
        } else if (viewId == R.id.buttonStartPlay) {
            // 开始实时预览
        ...
        } else if (viewId == R.id.buttonLocalCapture) {
            // 远程抓图
        ...
        } else if (viewId == R.id.preview_encode) {
            // 编码配置
            mEncodeBtn.setEnabled(false);
            onEncode();
        } else if (viewId == R.id.buttonStartRecord) {
            // 开始录像
            isRecord = !isRecord;
            onRecord(v, isRecord);
        } else if (viewId == R.id.preview_setpreset) {
            // 设置预置点
        ...
        } else if (viewId == R.id.preview_clearpreset) {
            // 清除预置点
            if (text != null && !text.equals("")) {
        ...
        } else if (viewId == R.id.preview_gotopreset) {
            // 跳转预置点
            if (text != null && !text.equals("")) {
        ...
        } else if (viewId == R.id.preview_focus_add) {
            // 变焦+
        ...
        } else if (viewId == R.id.preview_focus_dec) {
            // 变焦-
        ...
        } else if (viewId == R.id.preview_aperture_add) {
            // 光圈+
        ...
        } else if (viewId == R.id.preview_aperture_dec) {
            // 光圈-
        ...
        } else if (viewId == R.id.preview_osd_channel) {// osd 通道标题
            // 本Demo只做主码流的叠加
        ...
        } else if (viewId == R.id.preview_osd_time) {// osd 时间标题
            // 本Demo只做主码流的叠加
        ...
        } else if (viewId == R.id.encode_set_layout) {// 压缩格式
        ...
        } else if (viewId == R.id.resolution_set_layout) {
            // 分辨率
            if (!encodeModule.hasVideoCaps()) {
                return;
            }
            ...
            AlertDialog dialog = new AlertDialog.Builder(this)
                    ...
                    .setNegativeButton(getString(R.string.cancel), null).show();
        } else if (viewId == R.id.frame_rate_set_layout) {// 帧率
            if (!encodeModule.hasVideoCaps()) {
                return;
            }
            ...
            AlertDialog dialog = new AlertDialog.Builder(this)
                    ...
                    .setNegativeButton(getString(R.string.cancel), null).show();
        } else if (viewId == R.id.bit_rate_set_layout) {// 码流
            if (!encodeModule.hasVideoCaps()) {
                return;
            }
            ...
            AlertDialog dialog = new AlertDialog.Builder(this)
                    ...
                    .setNegativeButton(getString(R.string.cancel), null).show();
        } else if (viewId == R.id.audio_encode_mode_set_layout) {// 音频编码模式
            ...
            AlertDialog dialog = new AlertDialog.Builder(this)
                    ...
                    .setNegativeButton(getString(R.string.cancel), null).show();
        } else if (viewId == R.id.audio_rate_set_layout) {// 音频采样率
            if (!encodeModule.hasAudioCaps()) {
                return;
            }
