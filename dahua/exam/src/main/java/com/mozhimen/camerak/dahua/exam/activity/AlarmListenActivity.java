...
import com.mozhimen.camerak.dahua.exam.module.AlarmListenModule;
import com.mozhimen.camerak.dahua.exam.module.AlarmListenModule.AlarmEventInfo;
import com.mozhimen.camerak.dahua.exam.module.AlarmListenModule.AlarmStatus;
...
public class AlarmListenActivity extends AppCompatActivity implements View.OnClickListener, CB_fMessageCallBack {
    ...
    public void onClick(View v) {
        int id = v.getId();
        if (id == R.id.alarm_start_listen_bt) {
            listenAlarm(v);
        }
    }
