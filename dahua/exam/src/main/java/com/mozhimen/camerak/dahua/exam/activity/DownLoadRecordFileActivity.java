...
import com.mozhimen.camerak.dahua.exam.module.DownLoadRecordFileModule;
...
public class DownLoadRecordFileActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        int id = v.getId();
        if (id == R.id.download_start_date || id == R.id.download_start_time) {
            selectDownloadTime(DOWNLOAD_START_DATE_TIME);
        } else if (id == R.id.download_end_date || id == R.id.download_end_time) {
    ...
    private void createTimeDialog() {
        timeDialog = new AlertDialog.Builder(DownLoadRecordFileActivity.this)
