...
import com.mozhimen.camerak.dahua.exam.activity.APConfig.ApIPLoginActivity;
...
import com.mozhimen.camerak.dahua.exam.module.InitDevAccountModule;
...
public class InitDevAccountActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        } else if (id == R.id.device_initialize_button) {
            if (checkInitInfo()) {
