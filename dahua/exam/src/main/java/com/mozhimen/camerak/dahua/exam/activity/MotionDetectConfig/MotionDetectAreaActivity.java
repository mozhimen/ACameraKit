package com.mozhimen.camerak.dahua.exam.activity.MotionDetectConfig;
...
import com.mozhimen.camerak.dahua.exam.activity.MotionDetectConfig.view.CustomHScrollView;
import com.mozhimen.camerak.dahua.exam.activity.MotionDetectConfig.view.CustomScrollView;
import com.mozhimen.camerak.dahua.exam.activity.MotionDetectConfig.view.MotionAreaView;
...
public class MotionDetectAreaActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.motion_sense_level_layout) {// 灵敏度
        ...
        } else if (id == R.id.motion_threshold_layout) {
            // 阀值
            ...
            AlertDialog dialog = new AlertDialog.Builder(this)
                    ...
                    .setNegativeButton(res.getString(R.string.cancel), null).show();
        } else if (id == R.id.motion_detect_area_edit) {// 画图
        ...
        } else if (id == R.id.motion_detect_area_delete) {// 擦除
