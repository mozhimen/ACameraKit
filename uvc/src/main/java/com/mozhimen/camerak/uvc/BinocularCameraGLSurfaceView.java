...
import com.mozhimen.camerak.uvc.preview.CameraSurfaceTexture;
import com.mozhimen.camerak.uvc.preview.CameraSurfaceTextureListener;
import com.mozhimen.camerak.uvc.preview.CameraSurfaceView;
    ...
    public BinocularCameraGLSurfaceView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            ...
            if (a != null) {
                ...
                this.rgbCamreaId = a.getInt(R.styleable.cameraStyle_rgbCamera, 0);
                this.irCameraId = a.getInt(R.styleable.cameraStyle_irCamera, 1);
                this.showCameraId = a.getInt(R.styleable.cameraStyle_cameraPreviewId, rgbCamreaId);
