...
import com.mozhimen.camerak.uvc.BinocularCameraGLSurfaceView;
...
public class BinocularGLSurfaceActivity extends AppCompatActivity {
    ...
    public static final String TAG = "BinocularGLSurfaceActivity";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        textView.setText("BinocularGLSurface");
