 ...
 * @Version 1.0
 */
class CameraFrameFilter : FrameAFilter() {
    ...
    override fun onFilterSizeChanged(width: Int, height: Int) {
        ...
        if (this._width != width || this._height != height) {
            ...
            GLES20Util.genTexturesAndParameterf(1, _fTexture, 0, GLES20.GL_RGBA, width, height)
        }
    }
    ...
    override fun draw() {
        ...
        GLES20Util.bindFrameBuffer(_fFrame[0], _fTexture[0])
