package com.mozhimen.camerak_gl
...
import com.mozhimen.camerak_gl.helpers.GLSurfaceRenderer
import java.util.*
...
class CameraKGLProxy(activity: Activity, renderer: GLSurfaceRenderer) {
